...
const styles = StyleSheet.create({
  ...
  label: { fontSize: 9.5, letterSpacing: 1.0, marginBottom: 8, opacity: 0.5 },
  input: {
    borderWidth: 1,
    borderRadius: 6,
    padding: 12,
  ...
  templateDesc: { fontSize: 11, opacity: 0.5, marginTop: 2 },
  createBtn: {
    height: 44,
    borderRadius: 6,
    alignItems: 'center',
