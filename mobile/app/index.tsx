          ...
          {currentScreen === 5 ? (
            <View style={{ gap: 10, width: '100%' }}>
              ...
              <TouchableOpacity
                ...
                disabled={signingIn}
              >
                <View style={[styles.ctaButton, { backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#D1D5DB' }]}>
                  <View style={styles.ctaButtonContent}>
                    ...
                    <Text style={[styles.ctaText, { color: '#1F2937', fontFamily: 'Inter_600SemiBold' }]}>
                      Continue with Google
                    </Text>
                  </View>
                </View>
