...
const WORKFLOW_TOOLS = [
  ...
  },
  {
    name: "Antigravity",
    icon: (
      <svg className="w-4 h-4 shrink-0 text-indigo-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
