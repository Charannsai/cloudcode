            ...
            <div className="flex items-center gap-6 relative">
              <div className="relative">
                ...
                >
                  ...
                  >
                    <svg className="w-3.5 h-3.5 mr-2.5 text-zinc-400 group-hover/item:text-indigo-500 dark:group-hover/item:text-white transition-colors shrink-0" viewBox="0 0 24 24" fill="currentColor">
...
const WORKFLOW_TOOLS = [
  {
    name: "GitHub",
    icon: (
      <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="#8B949E">
  ...
  },
  {
    ...
    icon: (
      <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24">
        <path d="m22.65 14.39-10.65 7.74-10.65-7.74a.84.84 0 0 1-.3-.94l2.27-7a.84.84 0 0 1 .8-.58h15.76a.84.84 0 0 1 .8.58l2.27 7a.84.84 0 0 1-.3.94z" fill="#FC6D26"/>
        <path d="M12 22.13L1.35 14.39h21.3L12 22.13z" fill="#FC6D26"/>
        <path d="M1.35 14.39l2.27-7a.84.84 0 0 1 .8-.58h3.33L1.35 14.39z" fill="#E24329"/>
        <path d="M22.65 14.39l-2.27-7a.84.84 0 0 0-.8-.58h-3.33l6.4 7.58z" fill="#E24329"/>
        <path d="M12 22.13V11.21H7.75l4.25 10.92z" fill="#FCA326"/>
        <path d="M12 22.13V11.21h4.25l-4.25 10.92z" fill="#FCA326"/>
      </svg>
    )
  },
  {
    ...
    icon: (
      <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24">
        <path d="M23.985 6.891a.502.502 0 00-.147-.282L19.22 1.637a.501.501 0 00-.847.337v3.528L4.041 1.054a.502.502 0 00-.585.07L.18 3.993a.502.502 0 00-.012.7L4.76 9.423.168 14.161a.502.502 0 00.012.7l3.276 2.869a.502.502 0 00.585.07l14.332-4.448v3.528a.501.501 0 00.847.337l4.619-4.973c.1-.107.156-.251.156-.4V7.292c0-.149-.056-.293-.156-.4z" fill="#007ACC"/>
        <path d="M1.168 14.161l3.276 2.869c.2-.2.3-.4.3-.6V7.57a.5.5 0 0 0-.3-.6L1.168 9.839a.502.502 0 00-.012.7l.012 3.622z" fill="#0065B3"/>
        <path d="M18.873 11.23L12 9.091V6.262l6.873 2.15v2.818z" fill="#1F9CF0"/>
      </svg>
    )
  },
  {
    ...
    icon: (
      <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24">
        <rect width="24" height="24" fill="#CB3837" rx="3" />
        <path d="M4 8h16v8h-4V12h-4v4H4V8zm4 4H8v4h4v-4zm4 0h-4v4h4v-4z" fill="#FFFFFF" />
      </svg>
    )
  },
  {
  ...
  },
  {
    name: "Node",
    icon: (
      <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="#339933">
        <path d="M12 2a1 1 0 0 0-.5.14l-8 4.63c-.31.18-.5.53-.5.91v9.23c0 .38.19.73.5 1.03l8 4.62c.3.18.7.18 1 0l8-4.62c.31-.3.5-.65.5-1.03V7.69c0-.38-.19-.73-.5-1.03l-8-4.63A1 1 0 0 0 12 2zm1 4.3l5.5 3.18v6.36L13 19.3v-13z"/>
      </svg>
    )
  },
  {
    ...
    icon: (
      <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24">
        <path d="M12.12 1.5c-2.84 0-2.66 1.23-2.66 1.23l.01 1.28h2.7v.38H8.35S6 4.41 6 7.23c0 2.83 2.06 2.68 2.06 2.68h1.22v-1.1s-.04-1.48 1.46-1.48h2.7s1.26.04 1.26-1.16V3.27S14.78 1.5 12.12 1.5z" fill="#3776AB"/>
        <path d="M11.88 22.5c2.84 0 2.66-1.23 2.66-1.23l-.01-1.28h-2.7v-.38h3.82s2.35-.02 2.35-2.84c0-2.83-2.06-2.68-2.06-2.68h-1.22v1.1s.04 1.48-1.46 1.48h-2.7s-1.26-.04-1.26 1.16v3.27s-.92 1.77 1.74 1.77z" fill="#FFD343"/>
      </svg>
    )
  },
  {
    name: "Rust",
    icon: (
      <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="#CE412B">
  ...
  },
  {
    name: "Go",
    icon: (
      <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="#00ADD8">
        <path d="M1.72 10.24c-.06.27-.12.54-.18.81-.36 1.6-.72 3.21-1.08 4.81l.05.02c.49-.66.97-1.32 1.45-1.99.78-1.07 1.55-2.14 2.33-3.21.36-.5.71-.99 1.07-1.49l.06-.08c.55-.77 1.11-1.54 1.66-2.31.25-.34.49-.69.74-1.03l.03-.04A7.47 7.47 0 0 1 14.88 2c2.09 0 3.73.54 4.93 1.61 1.21 1.07 1.81 2.58 1.81 4.52 0 1.9-.56 3.49-1.69 4.77-1.12 1.28-2.65 1.92-4.57 1.92-1.63 0-2.92-.4-3.87-1.19-.94-.8-1.45-1.93-1.52-3.41h2.95c.06.69.29 1.21.7 1.57.41.36.95.54 1.63.54 1.13 0 1.95-.39 2.45-1.16.51-.78.76-1.89.76-3.33 0-1.29-.26-2.28-.77-2.97-.52-.68-1.29-1.02-2.32-1.02-1.39 0-2.38.64-2.97 1.91l-.22.47c-.5 1.07-1.01 2.14-1.52 3.21l-.04.09c-.52 1.11-1.05 2.22-1.57 3.33l-.04.09c-.48 1.02-.96 2.05-1.44 3.07-.33.7-.66 1.41-.99 2.11l-.03.07a12.8 12.8 0 0 1-1.96 3.25c-.75.87-1.66 1.3-2.73 1.3-1.05 0-1.87-.39-2.45-1.17S0 19.34 0 17.8c0-1.51.35-2.88 1.06-4.1.7-.16 1.41-.33 2.12-.49.03-.07.06-.13.09-.2.24-.55.48-1.1.72-1.65.23-.53.46-1.05.69-1.58.1-.22.19-.44.29-.66-.41.1-.81.19-1.22.29-.02.04-.04.08-.06.12-.44.96-.87 1.92-1.31 2.88-.14.3-.28.6-.42.9l-1.32.3zm20.3-4.83H17.8v2.79h4.22V8.2z"/>
      </svg>
    )
  },
  {
    name: "PostgreSQL",
    icon: (
      <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="#336791">
  ...
  },
  {
    name: "Next.js",
    icon: (
      <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill={theme === "dark" ? "#FFFFFF" : "#000000"}>
        <path d="M12 0c6.627 0 12 5.373 12 12s-5.373 12-12 12S0 18.627 0 12 5.373 0 12 0zm0 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm1 10.5l4.5 4.5h-1.5l-4.5-4.5v4.5h-1.5v-9h1.5l4.5 4.5v-4.5h1.5v9H13z"/>
      </svg>
    )
  },
  {
    ...
    icon: (
      <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24">
        ...
        <path d="M20.063 17.575c-.213-.675-.625-1.125-1.275-1.425-.65-.3-1.425-.375-2.225-.225s-1.375.525-1.65 1.125c-.275.6-.275 1.25-.025 1.8.25.55.775.925 1.5 1.1.725.175 1.625.15 2.5-.075l.275 1.275c-1 .375-2.125.425-3.15.15-1.025-.275-1.825-.925-2.25-1.85-.425-.925-.375-2.025.15-2.925.525-.9 1.475-1.475 2.625-1.55 1.15-.075 2.275.25 3.025.925.75.675 1.15 1.6 1.125 2.6l-1.375.075zm-9.3-.575v1.275H8.388v-7.35h6.6v1.275h-2.35v6.075H10.76z" fill="#FFFFFF"/>
      </svg>
    )
  },
  {
        ...
        {scrollProgress >= 0.35 && (
          ...
          >
            ...
            <div className="flex flex-col items-center gap-6 select-none relative">
              ...
              <div 
                className="absolute w-[350px] h-[350px] rounded-full blur-[100px] pointer-events-none transition-all duration-100 ease-out -z-1"
                style={{ 
                  opacity: glowOpacity,
